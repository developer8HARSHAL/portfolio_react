...
const Header = () => {
  ...
  return (
    <header
      className={`fixed top-0 left-10 right-10 z-50 transition-all duration-500 ${
        isScrolled
      ...
      <div className="w-[90%] lg:w-[85%] xl:w-[80%] mx-auto">
        <div className="flex items-center justify-between gap-8 py-4 lg:py-5">
          ...
          <nav className="hidden lg:flex items-center gap-2 xl:gap-4 flex-1 justify-center">
            {navLinks.map((item) => (
              <button
                ...
                className={`relative px-4 xl:px-6 py-3 text-[15px] xl:text-[16px] font-medium rounded-lg transition-all duration-300 cursor-pointer group ${
              ...
              >
                ...
                <span
                  className={`absolute bottom-1 left-1/2 -translate-x-1/2 h-0.5 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full transition-all duration-300 ${
          ...
          <button
            ...
            className="lg:hidden relative z-50 w-10 h-10 flex items-center justify-center bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-400/50 flex-shrink-0"
          ...
          {/* Mobile Menu */}
          <div
            className={`mobile-menu-container lg:hidden fixed inset-0 z-40 transition-all duration-500 ${
          ...
          >
            ...
            {/* Menu Content */}
            <div
              className={`absolute top-0 right-0 h-full w-full sm:w-80 bg-slate-900/95 backdrop-blur-2xl border-l border-white/10 shadow-2xl transition-transform duration-500 ${
                ...
                <nav className="flex-1 space-y-2">
                  {navLinks.map((item, index) => (
                    <button
                      key={item.id}
                      onClick={() => handleScrollTo(item.to)}
                      className={`w-full text-left px-6 py-4 text-[17px] font-medium rounded-xl transition-all duration-300 cursor-pointer ${
                        activeSection === item.id
                ...
                <div className="border-t border-white/10 pt-6 space-y-4">
                  ...
                  <div className="flex justify-center gap-3">
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-11 h-11 flex items-center justify-center bg-white/5 hover:bg-white/10 border border-white/10 hover:border-blue-500/50 rounded-lg transition-all duration-300 text-slate-400 hover:text-blue-400"
                      aria-label="GitHub"
                    >
