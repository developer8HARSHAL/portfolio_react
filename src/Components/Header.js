            ...
            <div className="container mx-auto py-1 px- sm:px-6 lg:px-8 text-2xl text-white sticky">
                <div className="flex items-center justify-between">
                    ...
                    <div className="hidden md:block border-2 py-4 px-8 mx-10 hover:border-yellow-300">
                        <a href="/assets/HarshalPinge_Resume.pdf" target="_blank" rel="noopener noreferrer" className="text-yellow-400 border-yellow-400 font-bold py-2 px-4 rounded hover:text-yellow-400">
                            Resume
                        </a>
                    </div>
                </div>
