  ...
  const projects = [
    {
      ...
      category: "Full-Stack",
      description: "Production-ready document management platform with 25+ RESTful APIs, JWT authentication, and 3-level RBAC, enabling secure document sharing and automated email-based onboarding for team collaboration.",
    ...
    },
    {
      ...
      category: "Tools & SDK",
      description: "Published npm package for API monitoring that helps developers track performance across 100+ endpoints, processing 10K+ requests/hour with <50ms latency. Features real-time analytics dashboard with comprehensive request visualization.",
