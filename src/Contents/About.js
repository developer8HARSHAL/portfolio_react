    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          ...
          observer.disconnect(); // mirrors AOS `once: true`
        }
      },
      { threshold: 0.12 }
    );
            ...
            <div className="card-glass-hover p-8 group">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-base text-slate-400 mt-2">Zeal College, Pune • 2021–2025</p>
                  <p className="text-sm text-slate-500 mt-1">Minor: Data Science</p>
                </div>
              </div>
            </div>
            ...
            <div className="card-glass-hover p-8 group">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-base text-slate-400 mt-2">Fulcrum Resources • Nov 2024 – Feb 2025</p>
                  <div className="flex items-center gap-2 mt-2">
                    <div className="flex items-center">
                      ...
                      <svg className="w-4 h-4 text-yellow-400 opacity-50" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                      </svg>
                    </div>
            ...
            <div className="card-glass-hover p-8 group">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-base text-slate-400 mt-2">100+ problems solved on LeetCode</p>
                </div>
              </div>
            </div>
            ...
            <div className="card-glass p-10">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4 group">
                  ...
                  <p className="text-lg text-slate-300 leading-relaxed">
                    Computer Engineering graduate (2025) from Zeal College, Pune, specializing in{' '}
                    <span className="text-blue-400 font-semibold">Frontend development</span> with hands-on experience in the{' '}
                    <span className="text-blue-400 font-semibold">MERN stack</span>. Completed a minor in{' '}
                    <span className="text-blue-400 font-semibold">Data Science</span>, combining development skills with data-driven problem-solving.
                  </p>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <p className="text-lg text-slate-300 leading-relaxed">
                    During my internship at <span className="text-green-400 font-semibold">Fulcrum Resources</span>, I designed an employee management system using Next.js, improving HR efficiency by 35% and achieving a{' '}
                    <span className="text-green-400 font-semibold">4.5/5 performance rating</span>.
                  </p>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <p className="text-lg text-slate-300 leading-relaxed">
                    I've built production-ready projects including an{' '}
                    <span className="text-purple-400 font-semibold">Enterprise Document Management System</span> with 25+ REST APIs and published an{' '}
                    <span className="text-purple-400 font-semibold">npm package (DevMetrics SDK)</span> for API monitoring.
                  </p>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <p className="text-lg text-slate-300 leading-relaxed">
                    With strong problem-solving skills (<span className="text-cyan-400 font-semibold">100+ LeetCode problems</span> solved) and a proven track record, I'm seeking entry-level full-stack developer roles where I can build scalable, impactful web applications.
                  </p>
                </div>
              </div>
            </div>
